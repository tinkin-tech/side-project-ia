  ...
  <div>
    <div className="max-w-xs md:max-w-2xl mx-auto py-16">
      ...
      <div className="text-center text-sm text-gray-500 pl-32 pr-32 mt-5">
        Copia y pega el texto que deseas analizar en el recuadro a continuación
        y te diremos como se siente tu usuario*
      </div>
    </div>
    <div className="max-w-xs md:max-w-7xl mx-auto py-16 bg-dark rounded-md grid grid-cols-2 gap-3">
      <div className="ml-32">
        <textarea
          className="resize-none bg-blue-500 rounded-lg ml-56 text-white text-center -mb-8 border-0"
          disabled={true}
        />
        <img className="object-none -mb-56" src="/img/robot.svg" alt="robot" />
      </div>
      <div className="flex flex-col mr-4">
        <div className="w-full bg-white py-6 rounded-md">
          <span className="font-bold ml-4 mr-8">Elige el servicio de IA:</span>
